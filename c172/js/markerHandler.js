...
AFRAME.registerComponent("markerhandler", {
  ...
  handlePayment:function(){
    ...
    var tNumber
    tableNumber <= 9 ? (tNumber = `T0${tableNumber}`) : `T${tableNumber}`;
    firebase.firestore().collection("tables").doc(tNumber).update({current_orders:{},total_bill:0
    })
    .then(()=>{
      swal({
        icon:"success",
        title:"Thanks for paying!",
        text:"We hope you enjoyed your food, and we hope to see you again soon.",
        timer:2500,
        buttons:false,
      });
    });
